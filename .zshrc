...
# Theme is sourced manually below via Homebrew's powerlevel10k, so leave this empty.
ZSH_THEME=""
...
# Command autosuggestions (installed via Homebrew, independent of Oh My Zsh).
