...
EXCLUDES=(
  "install.sh" "bootstrap.sh" "kanata_setup.sh" "install_builtin_watcher.sh" "install_nuphy_runner.sh" "install_unlock_watcher.sh" "install_external_keyboard_detector.sh" "packages.yaml" "README.md" ".gitignore"
  ...
  "launchd/local.kanata.external-keyboard-detector.plist"
